...
module "compute_instance" {
  source                 = "git::https://github.com/SyncArcs/terraform-google-vm.git?ref=v1.0.0"
  version                = "1.0.0"
  name                   = "app"
  environment            = "test"
  instance_count         = 1
...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/SyncArcs/terraform-google-vm/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the **MIT** License - see the [LICENSE](https://github.com/SyncArcs/terraform-google-vm/blob/master/LICENSE) file for details.
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/SyncArcs/terraform-google-vm"` | no |
